          ...
          <div className="inline-flex space-x-3">
            {data.map((movie: any) => (
              ...
              >
                ...
                />
                <div className="p-4">
                  <h3 className=" text-white dark:text-gray-800 text-lg font-bold truncate">
                    {movie.title}
                  </h3>
                  <div className="flex items-center mt-2">
                    <span className="text-yellow-400">★</span>
                    <span className="ml-1 text-white dark:text-gray-800 text-sm">
                      {movie.vote_average.toFixed(1)}
                    </span>
                  </div>
                  <p className="text-sm text-gray-400 dark:text-gray-800 mt-2">
